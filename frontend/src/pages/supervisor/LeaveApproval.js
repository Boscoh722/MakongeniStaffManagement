            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                ...
                <div className="flex items-center">
                  <div className="h-12 w-12 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center mr-4">
                    <span className="text-lg font-medium text-gray-600 dark:text-gray-300">
                      {selectedLeave.staff.firstName.charAt(0)}{selectedLeave.staff.lastName.charAt(0)}
                    </span>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      {selectedLeave.staff.employeeId} • {selectedLeave.staff.department} • {selectedLeave.staff.position}
                    </p>
                  </div>
                </div>
              </div>
