  ...
  const getNavigation = () => {
    ...
    if (user?.role === 'supervisor') {
      return [
        ...
        { name: 'Performance', href: '/supervisor/performance', icon: ChartBarIcon, color: 'text-green-500' },
      ];
    }
    ...
    if (user?.role === 'clerk') {
      return [
        ...
        { name: 'Leave Processing', href: '/clerk/leaves', icon: CalendarIcon, color: 'text-royal-500' },
        { name: 'Reports', href: '/clerk/reports', icon: DocumentTextIcon, color: 'text-scarlet-500' },
      ];
    }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {isProfileDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white/95 dark:bg-neutral-800/95 backdrop-blur-sm rounded-2xl shadow-xl border border-mustard-100 dark:border-mustard-900/30 overflow-hidden z-50">
